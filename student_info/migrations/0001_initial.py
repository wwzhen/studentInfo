    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.CharField(max_length=64, null=True, verbose_name='\u521b\u5efa\u4eba', db_column=b'creator', blank=True)),
                ('modifier', models.CharField(max_length=64, null=True, verbose_name='\u6700\u540e\u66f4\u65b0\u4eba', db_column=b'modifier', blank=True)),
                ('sn', models.CharField(max_length=64, null=True, verbose_name='\u60e9\u7f5a\u4ee3\u7801', db_column=b'sn', blank=True)),
                ('discipline_time', models.DateTimeField(verbose_name='\u60e9\u7f5a\u65f6\u95f4', db_column=b'time')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(default=b'man', max_length=16, verbose_name='\u6027\u522b', db_column=b'sex', choices=[(b'man', b'\xe7\x94\xb7'), (b'woman', b'\xe5\xa5\xb3'), (b'other', b'\xe5\x85\xb6\xe4\xbb\x96')])),
                ...
                ('punishment', models.ForeignKey(blank=True, to='student_info.Discipline', null=True)),
            ],
            options={
                'abstract': False,
            },
